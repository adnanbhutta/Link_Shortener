...
const spec = {
  ...
  DB_CLIENT: str({ choices: supportedDBClients, default: process.env.DATABASE_URL ? "pg" : "better-sqlite3" }),
  ...
  JWT_SECRET: str({ default: "securekey-change-me-in-production" }),
  MAIL_ENABLED: bool({ default: false }),
  MAIL_HOST: str({ default: "" }),
  MAIL_PORT: num({ default: 587 }),
  MAIL_SECURE: bool({ default: false }),
  MAIL_USER: str({ default: "" }),
  MAIL_FROM: str({ default: "", example: "Link_Shortener <support@yourdomain.com>" }),
